...
a.keyCode;if(13==b&&-1<c.index)a.preventDefault(),c.select();else if(27==b)c.close();else if(38==b||40==b)a.preventDefault(),c[38==b?"previous":"next"]()}});d.bind(this.input.form,{submit:function(a){c.close()}});d.bind(this.ul,{click:function(a){a=a.target;if(a!=this){for(;a&&!/li/i.test(a.nodeName);)a=a.parentNode;a&&c.select(a)}}})};g.prototype={set list(a){Array.isArray(a)?this._list=a:"string"==typeof a&&-1<a.indexOf(",")?this._list=a.split(/\s*,\s*/):(a=d(a))&&a.children&&(this._list=[].slice.apply(a.children).map(function(a){return a.innerHTML.trim()}))},
close:function(){this.ul.setAttribute("hidden","");this.index=-1;d.fire(this.input,"awesomplete-close")},open:function(){this.ul.removeAttribute("hidden");var a=this;document.addEventListener("click",function(b){a.container.contains(b.target)||(document.removeEventListener("click",arguments.callee),a.close())});this.autoFirst&&-1==this.index&&this.goto(0);d.fire(this.input,"awesomplete-open")},next:function(){this.goto(this.index<this.ul.children.length-1?this.index+1:-1)},previous:function(){var a=
this.ul.children.length;this.goto(-1<this.index?this.index-1:a-1)},goto:function(a){var b=this.ul.children;-1<this.index&&b[this.index].setAttribute("aria-selected","false");this.index=a;-1<a&&0<b.length&&b[a].setAttribute("aria-selected","true")},select:function(a){if(a=a||this.ul.children[this.index]){var b;d.fire(this.input,"awesomplete-select",{text:a.textContent,preventDefault:function(){b=!0}});b||(this.input.value=a.textContent,this.close(),d.fire(this.input,"awesomplete-selectcomplete"))}},
evaluate:function(){var a=this,b=this.input.value;b.length>=this.minChars&&0<this._list.length?(this.index=-1,this.ul.innerHTML="",this._list.filter(function(c){return a.filter(c,b)}).sort(this.sort).every(function(c,d){a.ul.appendChild(a.item(c,b));return d<a.maxItems-1}),this.open()):this.close()}};g.FILTER_CONTAINS=function(a,b){return RegExp(h(b.trim()),"i").test(a)};g.FILTER_STARTSWITH=function(a,b){return RegExp("^"+h(b.trim()),"i").test(a)};g.SORT_BYLENGTH=function(a,b){return a.length!=b.length?
a.length-b.length:a<b?-1:1};k("input.awesomplete").forEach(function(a){new Awesomplete(a)});g.$=d;g.$$=k})();