...
describe("Awesomplete.$.unbind - external container", function () {
  $.fixture("plain");
  ...
  describe("with valid element", function () {
    ...
    it("removes event listeners for all events", function () {
      this.events = { click: $.noop, input: $.noop, scroll: $.noop };
      this.subject();

      expect(this.element.removeEventListener).toHaveBeenCalledWith(
        "click",
        this.events.click
      );
      expect(this.element.removeEventListener).toHaveBeenCalledWith(
