...
describe("awesomplete.destroy - external container", function () {
  $.fixture("plain");
  ...
  it("removes its elements from the DOM", function () {
    var instance = this.subject;
    var ulParentBefore = this.subject.ul.parentNode;

    instance.destroy();

    expect(instance.ul.parentNode).not.toBe(ulParentBefore);
    expect(document.body.contains(instance.container)).toBeTruthy();
    expect(document.body.contains(instance.ul)).toBeFalsy();
  });
